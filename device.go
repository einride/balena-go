...
const deviceBasePath = "v6/device"
...
type DeviceResponse struct {
	...
	IsOfDeviceType                     *DeviceTypeOData    `json:"is_of__device_type,omitempty"`
	...
	DeviceConfigVariable               *DeviceConfVarOData `json:"device_config_variable,omitempty"`
}
