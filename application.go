...
type ApplicationsResponse struct {
	...
	Organization                   *OrganizationOData `json:"organization,omitempty"`
...
type ApplicationsOData struct {
	D []*ApplicationsResponse
	*odata.Object
}

func (d *ApplicationsOData) UnmarshalJSON(data []byte) error {
	o := new(odata.Object)
